    ...
    <div className={`site-shell site-theme-${c.appearance.theme} min-h-screen bg-background text-foreground`}>
      ...
      <section id="top" className="hero-surface relative overflow-hidden">
        ...
        <div className="hidden lg:block absolute inset-y-0 right-0 w-1/2">
          <img src={c.hero.image} alt="Cores vibrantes da D.Tiba" className="w-full h-full object-cover [mask-image:linear-gradient(to_right,transparent_0%,black_22%)]" />
          {/* desvanecer + leve desfoque na transição esquerda */}
          <div className="absolute inset-y-0 left-0 w-64 backdrop-blur-md [mask-image:linear-gradient(to_right,black_0%,transparent_100%)]" />
